...
<%
    ...
    */
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                if (fi.isFormField()) {
                    ...
                    System.out.println("original FileNameExt:" + fileName.substring(fileName.lastIndexOf("."),fileName.length()));
                    
                    System.out.println("NewFileName:" + UUID.randomUUID() + fileName.substring(fileName.lastIndexOf("."),fileName.length()));
    ...
    response.sendRedirect("fileupload_send.jsp?result=success");
%>