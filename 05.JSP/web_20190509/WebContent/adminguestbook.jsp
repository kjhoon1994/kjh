	...
	for (Guestbook g : list) {
		...
		if (g.getBlind() == 0) {
			sb.append(String.format(
					"<td><div class='btn-group'><button type='button' class='btn btn-default disabled on' value="
							+ g.getSsn() + ">on</button>"));
			sb.append(String.format("<button type='button' class='btn btn-default active off value="
					+ g.getSsn() + "'>off</button></div></td>"));

			++cnt;
		} else {
			sb.append(String.format(
					"<td><div class='btn-group'><button type='button' class='btn btn-default active on' value="
							+ g.getSsn() + ">on</button>"));
			sb.append(String.format("<button type='button' class='btn btn-default disabled off' value="
					+ g.getSsn() + ">off</button></div></td>"));
			++bcnt;
		}
		sb.append(String.format("</tr>"));
		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="adminfile_send.jsp">사진관리</a></li>
